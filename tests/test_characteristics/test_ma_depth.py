    ...
    def test_dataset_1(self):
        ...
        expected = {
            binding_constant.start: {
                mode_constant.lossy: [4, 1.585, 1.585],
                mode_constant.normal: [4, 3.1699, 3.9069],
                mode_constant.redundant: [4, 5.1699, 4.9069],
                mode_constant.cycle: [4, 4.1699, 4.1699],
            },
            binding_constant.end: {
                mode_constant.normal: [4, 3.585, 2.585],
            },
        }
