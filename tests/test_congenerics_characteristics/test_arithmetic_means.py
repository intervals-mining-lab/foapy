...
from foapy.congenerics.characteristics import arithmetic_means


class TestArithmeticMeans(MACharacteristicsTest):
    """
    Test list for arithmetic_means calculate
    """

    epsilon = np.float_power(10, -100)

    def target(self, X, dtype=None):
        return arithmetic_means(X)
