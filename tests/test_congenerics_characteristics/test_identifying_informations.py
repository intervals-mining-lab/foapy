...
from foapy.congenerics.characteristics import identifying_informations


class TestIdentifyingInformations(MACharacteristicsTest):
    """
    Test list for identifying_informations calculate
    """

    epsilon = np.float_power(10, -100)

    def target(self, X, dtype=None):
        return identifying_informations(X)
