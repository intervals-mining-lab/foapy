...
from foapy.congenerics.characteristics import periodicities


class TestPeriodicities(MACharacteristicsTest):
    """
    Test list for periodicities calculate
    """

    epsilon = np.float_power(10, -15)

    def target(self, X, dtype=None):
        return periodicities(X)
