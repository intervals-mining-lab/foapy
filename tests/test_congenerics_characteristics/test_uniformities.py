...
from foapy.congenerics.characteristics import uniformities


class TestUniformities(MACharacteristicsTest):
    """
    Test list for uniformities calculate
    """

    epsilon = np.float_power(10, -15)

    def target(self, X, dtype=None):
        return uniformities(X)
